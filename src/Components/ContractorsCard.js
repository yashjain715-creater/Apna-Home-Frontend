...
class Contractorcard extends React.Component {
    ...
    componentDidMount() {
        this.props.onTryAutoFilter(this.props.match.params.city, this.props.match.params.type);
    }
...
const mapDispatchToProps = dispatch => {
    return {
        onTryAutoFilter: (city, type) => {
            dispatch(actions.filtercheckstate(city, type));
        },
